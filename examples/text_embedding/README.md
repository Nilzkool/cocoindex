...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Nilzkool/cocoindex/blob/main/examples/text_embedding/Text_Embedding.ipynb)
[![GitHub](https://img.shields.io/github/stars/Nilzkool/cocoindex?color=5B5BD6)](https://github.com/Nilzkool/cocoindex)

In this example, we will build index flow from text embedding from local markdown files, and query the index.

We appreciate a star ⭐ at [CocoIndex Github](https://github.com/Nilzkool/cocoindex) if this is helpful.
